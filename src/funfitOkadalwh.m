...
%
% Elena Reinisch 2018-AUG-24 build for cuboid representation
%
% Example .gin file:
%Parameter_Name Initial_Value PlusMinusBound
%E_grad__@_epoch_002_dimless_____     1e-8        0
%N_grad__@_epoch_002_dimless_____     1e-8        0
%U_grad__@_epoch_002_dimless_____     1e-8        0
%Poisson_Ratio_dimless___________     0.25        0
%Volume_Change_in_cubic_meters___    -3.0E+05     0
%Okada3_Easting_in_m_____________     3.0E+05     0
%Okada3_Northing_in_m____________     3.0E+06     0
%Okada3_Elevation_in_m___________    -3.0E+03     0
%Okada3_dX_in_m__________________     3.0E+03     0
%Okada3_dY_in_m__________________     3.0E+03     0
%Okada3_dZ_in_m__________________     3.0E+03     0
