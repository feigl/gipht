function ktours = plotbp(tepochs, cal_date, bpest, DD, species, iuniqorbs, uniqdates, plotts,ylab)
...
pix = 1/6; %amount of space needed for each label, dependent on values of tick marks
del = .1; %amount of space between each label, dependent on tick marks 
...
fclose(fidtxtout);
 ...
 set(FigHandle, 'Position', [100, 100, 595, 795]);%1049
