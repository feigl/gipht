function h1 = plotpairs_coso2(tm,ts,Qdiff,Qdsig,Qdmod ...
...
% set(h1,'DefaultTextInterpreter','None'); 
h1 = gcf;
hold on
...
axis auto
text(dyear(2013, 01, 01), -100, 'volume produced', 'Color','k','FontSize',12, 'FontWeight', 'bold')  
ylim([min(Qfsigl) max(Qfsigu)])
...
xlim([dyear(2003, 08, 01), dyear(2016, 06, 01)])
