function h1 = plotpairs5_delmaule(tm,ts,Qdiff,Qdsig,Qdmod ...
...
%        fprintf(1,'%3d %#10.4f %#10.4f %#12.4g %#12.4g %#12.4g\n',i,tm(i),ts(i),ppredm(i),ppreds(i),Qdsig(i));
        plot([tm(i),ts(i)],[ppredm(i)            ,ppreds(i)]         ,'ro-','MarkerEdgeColor','k','MarkerFaceColor', 'w', 'MarkerSize',4,'LineWidth',1); % segment between master and slave        
