function [pest, psig, mse, dmod, tfit, pfit, sfitl, sfitu, pfitd, rd, V, G, sswr, Vx, var, res_n] = temporal_adjustment_function_coso_gps_envi(data,data_sigma,tm,ts,tbreaks,tfunc,metaparams)
...
%% find components
dispflag = 0;
if exist('TA_gps_envi_new.mat') == 2
