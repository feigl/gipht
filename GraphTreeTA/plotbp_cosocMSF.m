function ktours = plotbp_cosocMSF(tepochs, bpest, DD, species, iuniqorbs, uniqdates, plotts,ylab, sat_id, cal_date)
...
%          plot([tepochs(id0(i)) tepochs(id1(i))],[bpest(id0(i)) bpest(id1(i))],mysym0{1+mod(j,length(mysym0))},'Linewidth',2,'MarkerFaceColor','k'); hold on;
        plot([tepochs(id0(i)) tepochs(id1(i))],[bpest(id0(i)) bpest(id1(i))],mysym0{sat_id(i)},'Linewidth',2,'MarkerFaceColor','k'); hold on;
...
%               plot([tepochs(id0(i)) tepochs(id1(i))],[bpest(id0(i)) bpest(id1(i))],mydash{1+mod(j,length(mydash))},'Linewidth',2,'MarkerFaceColor','k'); hold on;
              plot([tepochs(id0(i)) tepochs(id1(i))],[bpest(id0(i)) bpest(id1(i))],mydash{sat_id(i)},'Linewidth',2,'MarkerFaceColor','k'); hold on;
...
h2=ylabel('orbital separation [m]');         set(h2,'FontName','Courier','Fontsize',14,'FontWeight','bold');
