function [pest, psig, mse, dmod, tfit, pfit, sfitl, sfitu, pfitd, rd, V, G, sswr, Vx, var, res_n] = temporal_adjustment_function_coso_gps_s1a(data,data_sigma,tm,ts,tbreaks,tfunc,metaparams)
